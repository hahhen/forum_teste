                    ...
                    <Dialog.Trigger asChild>
                        <Tooltip.Trigger asChild>
                            <span className='_tooltipTrigger_11eqz_630'>
                                <button type="button" className="_toolbarButton_11eqz_218" data-toolbar-item="true" tabindex="0" data-orientation="horizontal" data-radix-collection-item="">
                                    <div class="mathlive-icon">
                        ...
                        <Dialog.Content className="DialogContent" onPointerDownOutside={(e) => e.preventDefault()}>
                            ...
                            <Collapsible.Root className="CollapsibleRoot" open={open} onOpenChange={setOpen}>
                                <div style={{ display: 'flex', alignItems: 'center' }}>
                                    <span className="Text" style={{ fontFamily: 'SFProDisplay', fontWeight: 500, color: 'var(--font)', marginRight: '10px' }}>
                                        Atalhos de teclado
                                    </span>
